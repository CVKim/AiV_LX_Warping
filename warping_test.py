    ...
    for file in source_directory.iterdir():
        if file.is_file() and file.suffix.lower() in ['.png', '.jpg', '.jpeg']:
            ...
            try:
                ...
                # 워핑된 이미지 저장
                warped_filename = file.stem + '_warped.jpg'
                warped_path = result_directory / warped_filename
                save_image(warped_path, warped_image, logger)
...
def main():
    ...
    result_directory = source_directory / 'RESULT'
